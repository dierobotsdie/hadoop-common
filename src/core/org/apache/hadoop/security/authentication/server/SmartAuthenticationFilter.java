...
/**
 * The {@link SmartAuthenticationFilter} enables protecting web application resources with different (pluggable)
 * authentication mechanisms.
 * <p/>
 * Out of the box it provides 2 authentication mechanisms: Pseudo and Kerberos SPNEGO.
 * <p/>
 * Additional authentication mechanisms are supported via the {@link SmartAuthenticationHandler} interface.
 * <p/>
 ...
 * {@link PseudoAuthenticationHandler}, 'kerberos' is short for {@link SmartKerberosAuthenticationHandler}, otherwise
 ...
 * </ul>
 * <p/>
 * The rest of the configuration properties are specific to the {@link SmartAuthenticationHandler} implementation and the
 ...
 */
public class SmartAuthenticationFilter implements Filter {

  private static Logger LOG = LoggerFactory.getLogger(SmartAuthenticationFilter.class);
  ...
  public void init(FilterConfig filterConfig) throws ServletException {
    ...
    if (authHandlerName.equals("simple")) {
      ...
      authHandlerClassName = SmartKerberosAuthenticationHandler.class.getName();
    } else {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain)
    ...
    try {
      ...
      if (token != null) {
        ...
        throw new AuthenticationException("Missing AuthenticationToken or active Kerberos credential.");
      }
    } catch (AuthenticationException ex) {
